...
}var $author$project$Records$DataTypes$LinkClicked = function (a) {
...
var $author$project$RecordsApp$main = $elm$browser$Browser$application(
	{init: $author$project$RecordsApp$init, onUrlChange: $author$project$Records$DataTypes$UrlChanged, onUrlRequest: $author$project$Records$DataTypes$LinkClicked, subscriptions: $author$project$RecordsApp$subscriptions, update: $author$project$RecordsApp$update, view: $author$project$RecordsApp$view});
