...
{
	if (region.aG.a5 === region.aW.a5)
	{
		return 'on line ' + region.aG.a5;
	}
	return 'on lines ' + region.aG.a5 + ' through ' + region.aW.a5;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { cz: 'hidden', b8: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { cz: 'mozHidden', b8: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { cz: 'msHidden', b8: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { cz: 'webkitHidden', b8: 'webkitvisibilitychange' }
		: { cz: 'hidden', b8: 'visibilitychange' };
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.cS, request.dW, true);
		} catch (e) {
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {aZ: fragment, a1: host, bg: path, bi: port_, bl: protocol, bm: query};
	});
...
var $author$project$Search$DataTypes$Model = F8(
	function (key, url, query, response, errorMessage, viewingDevice, language, currentRoute) {
		return {cg: currentRoute, cn: errorMessage, cN: key, cO: language, bm: query, c6: response, dW: url, dZ: viewingDevice};
	});
var $author$project$Api$Search$NoResponseToShow = {$: 3};
var $author$project$Api$Search$SearchQueryArgs = F3(
	function (query, filters, sort) {
		return {cs: filters, bm: query, dk: sort};
	});
...
var $mdgriffith$elm_ui$Element$classifyDevice = function (window) {
	return {
		b9: function () {
			var shortSide = A2($elm$core$Basics$min, window.d_, window.cy);
			var longSide = A2($elm$core$Basics$max, window.d_, window.cy);
			return (shortSide < 600) ? 0 : ((longSide <= 1200) ? 1 : (((longSide > 1200) && (longSide <= 1920)) ? 2 : 3));
		}(),
		bd: (_Utils_cmp(window.d_, window.cy) < 0) ? 0 : 1
	};
};
...
var $author$project$Search$DataTypes$NotFound = 2;
var $elm$url$Url$Parser$State = F5(
	function (visited, unvisited, params, frag, value) {
		return {E: frag, I: params, D: unvisited, dX: value, L: visited};
	});
var $elm$url$Url$Parser$getFirstMatch = function (states) {
	...
	while (true) {
		if (!states.b) {
			...
			var _v1 = state.D;
			if (!_v1.b) {
				return $elm$core$Maybe$Just(state.dX);
			} else {
				if ((_v1.a === '') && (!_v1.b.b)) {
					return $elm$core$Maybe$Just(state.dX);
				} else {
...
var $author$project$Search$DataTypes$FrontPageRoute = 0;
var $author$project$Search$DataTypes$SearchPageRoute = 1;
...
var $author$project$Search$DataTypes$routeParser = $elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
...
var $author$project$SearchApp$init = F3(
	function (flags, initialUrl, key) {
		var language = $author$project$Language$parseLocaleToLanguage(flags.az);
		...
		var initialDevice = A2($author$project$UI$Layout$detectDevice, flags.aL, flags.aK);
...
var $author$project$Api$Search$ApiError = {$: 2};
var $author$project$Api$Search$Loading = {$: 0};
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{bS: false, b_: r.b_, co: r.co, cx: r.cx, cS: r.cS, dL: r.dL, dR: r.dR, dW: r.dW}));
};
var $author$project$Api$Request$createRequest = F3(
	function (responseMsg, responseDecoder, url) {
		return $elm$http$Http$request(
			{
				b_: $elm$http$Http$emptyBody,
				co: A2($elm$http$Http$expectJson, responseMsg, responseDecoder),
				cx: _List_fromArray(
					[
...
var $author$project$Api$Search$SearchResponse = F4(
	function (id, items, view, facets) {
		return {cq: facets, a3: id, ax: items, dY: view};
	});
...
var $author$project$Api$Search$Facet = F3(
	function (alias, label, items) {
		return {bJ: alias, ax: items, ay: label};
	});
var $author$project$Api$Search$FacetItem = F4(
	function (value, label, selected, count) {
		return {cf: count, ay: label, df: selected, dX: value};
	});
...
var $author$project$Api$Search$facetItemDecoder = A3(
...
var $author$project$Api$Search$SearchResult = F4(
	function (id, label, type_, typeLabel) {
		return {a3: id, ay: label, dS: typeLabel, dT: type_};
	});
	...
	A3(
		...
		A3(
			...
			A3(
				...
				'id',
				$elm$json$Json$Decode$string,
				$elm$json$Json$Decode$succeed($author$project$Api$Search$SearchResult)))));
var $author$project$Api$Search$SearchPagination = F5(
	function (next, previous, first, last, totalPages) {
		return {ct: first, cP: last, cU: next, c4: previous, dQ: totalPages};
	});
...
var $author$project$Api$Search$searchUrl = function (queryArgs) {
	var qstring = A2($elm$url$Url$Builder$string, 'q', queryArgs.bm);
	return A3(
...
var $author$project$Api$Search$searchRequest = F2(
	function (responseMsg, queryArgs) {
		var url = $author$project$Api$Search$searchUrl(queryArgs);
				...
				if (!msg.a.$) {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								c6: $author$project$Api$Search$Response(response)
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					var error = msg.a.a;
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{cn: errorMessage, c6: $author$project$Api$Search$ApiError}),
						$elm$core$Platform$Cmd$none);
				}
			case 1:
				var query = msg.a.bm;
				...
				return (_Utils_cmp(
					...
					$elm$core$Platform$Cmd$none);
			case 2:
				var queryModel = model.bm;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{c6: $author$project$Api$Search$Loading}),
...
var $author$project$Search$DataTypes$NoOp = {$: 6};
...
var $mdgriffith$elm_ui$Internal$Model$asColumn = 1;
var $mdgriffith$elm_ui$Internal$Style$classes = {bH: 'a', an: 'atv', bK: 'ab', bL: 'cx', bM: 'cy', bN: 'acb', bO: 'accx', bP: 'accy', bQ: 'acr', aO: 'al', aP: 'ar', bR: 'at', ao: 'ah', ap: 'av', bU: 's', bY: 'bh', bZ: 'b', b$: 'w7', b1: 'bd', b2: 'bdt', aa: 'bn', b3: 'bs', ab: 'cpe', ca: 'cp', cb: 'cpx', cc: 'cpy', aT: 'c', ae: 'ctr', af: 'cb', ag: 'ccx', y: 'ccy', U: 'cl', ah: 'cr', ce: 'ct', ch: 'cptr', ci: 'ctxt', cu: 'fcs', aY: 'focus-within', cv: 'fs', cw: 'g', au: 'hbh', av: 'hc', a$: 'he', aw: 'hf', a0: 'hfp', cA: 'hv', cC: 'ic', cE: 'fr', aj: 'lbl', cH: 'iml', cI: 'imlf', cJ: 'imlp', cK: 'implw', cL: 'it', cM: 'i', a6: 'lnk', P: 'nb', ba: 'notxt', cX: 'ol', cZ: 'or', H: 'oq', c1: 'oh', be: 'pg', bf: 'p', c2: 'ppe', c9: 'ui', r: 'r', db: 'sb', dc: 'sbx', dd: 'sby', de: 'sbt', di: 'e', dj: 'cap', dl: 'sev', dt: 'sk', dw: 't', dx: 'tc', dy: 'w8', dz: 'w2', dA: 'w9', dB: 'tj', am: 'tja', dC: 'tl', dD: 'w3', dE: 'w5', dF: 'w4', dG: 'tr', dH: 'w6', dI: 'w1', dJ: 'tun', by: 'ts', K: 'clr', dU: 'u', aI: 'wc', bC: 'we', aJ: 'wf', bD: 'wfp', aM: 'wrp'};
var $mdgriffith$elm_ui$Internal$Model$Generic = {$: 0};
var $mdgriffith$elm_ui$Internal$Model$div = $mdgriffith$elm_ui$Internal$Model$Generic;
var $mdgriffith$elm_ui$Internal$Model$NoNearbyChildren = {$: 0};
var $mdgriffith$elm_ui$Internal$Model$columnClass = $mdgriffith$elm_ui$Internal$Style$classes.bU + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.aT);
var $mdgriffith$elm_ui$Internal$Model$gridClass = $mdgriffith$elm_ui$Internal$Style$classes.bU + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.cw);
var $mdgriffith$elm_ui$Internal$Model$pageClass = $mdgriffith$elm_ui$Internal$Style$classes.bU + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.be);
var $mdgriffith$elm_ui$Internal$Model$paragraphClass = $mdgriffith$elm_ui$Internal$Style$classes.bU + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bf);
var $mdgriffith$elm_ui$Internal$Model$rowClass = $mdgriffith$elm_ui$Internal$Style$classes.bU + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.r);
var $mdgriffith$elm_ui$Internal$Model$singleClass = $mdgriffith$elm_ui$Internal$Style$classes.bU + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.di);
	...
	switch (style.$) {
		...
		case 8:
			...
			return 'grid-rows-' + (A2(
				...
				$elm$core$String$join,
				'-',
				A2($elm$core$List$map, $mdgriffith$elm_ui$Internal$Model$lengthClassName, template.u)) + ('-space-x-' + ($mdgriffith$elm_ui$Internal$Model$lengthClassName(template.dm.a) + ('-space-y-' + $mdgriffith$elm_ui$Internal$Model$lengthClassName(template.dm.b)))))));
		case 9:
			var pos = style.a;
			return 'gp grid-pos-' + ($elm$core$String$fromInt(pos.r) + ('-' + ($elm$core$String$fromInt(pos.cd) + ('-' + ($elm$core$String$fromInt(pos.d_) + ('-' + $elm$core$String$fromInt(pos.cy)))))));
		case 11:
		...
		A2(
			...
			_List_fromArray(
				[
					...
					$elm$core$Maybe$Just(
					$mdgriffith$elm_ui$Internal$Model$formatColor(shadow.N))
				])));
};
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.cA, $mdgriffith$elm_ui$Internal$Style$classes.K)) + ':hover',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.cA, $mdgriffith$elm_ui$Internal$Style$classes.H)) + ':hover',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.cu, $mdgriffith$elm_ui$Internal$Style$classes.K)) + ':focus',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.cu, $mdgriffith$elm_ui$Internal$Style$classes.H)) + ':focus',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.an, $mdgriffith$elm_ui$Internal$Style$classes.K)) + ':active',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.an, $mdgriffith$elm_ui$Internal$Style$classes.H)) + ':active',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
...
var $mdgriffith$elm_ui$Internal$Style$overrides = '@media screen and (-ms-high-contrast: active), (-ms-high-contrast: none) {' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.bU) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.r) + (' > ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.bU) + (' { flex-basis: auto !important; } ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.bU) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.r) + (' > ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.bU) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.ae) + (' { flex-basis: auto !important; }}' + ($mdgriffith$elm_ui$Internal$Style$inputTextReset + ($mdgriffith$elm_ui$Internal$Style$sliderReset + ($mdgriffith$elm_ui$Internal$Style$trackReset + ($mdgriffith$elm_ui$Internal$Style$thumbReset + $mdgriffith$elm_ui$Internal$Style$explainer)))))))))))))));
...
var $mdgriffith$elm_ui$Internal$Style$emptyIntermediate = F2(
	function (selector, closing) {
		return {ad: closing, g: _List_Nil, C: _List_Nil, s: selector};
	});
					...
					case 3:
						...
						return _Utils_update(
							rendered,
							{
								g: A2(
									$elm$core$List$cons,
									{ad: '\n}', g: _List_Nil, C: props, s: '@supports (' + (prop + (':' + (value + (') {' + parent.s))))},
									rendered.g)
							});
					case 5:
						var selector = rule.a;
...
var $mdgriffith$elm_ui$Internal$Style$renderCompact = function (styleClasses) {
	...
	var renderClass = function (rule) {
		...
		if (!_v2.b) {
			...
			return rule.s + ('{' + (renderValues(rule.C) + (rule.ad + '}')));
		}
	};
		...
		switch (rule.$) {
			...
			case 9:
				...
				var modernPosition = A2(
					...
					_List_fromArray(
						[
							'grid-row: ' + ($elm$core$String$fromInt(position.r) + (' / ' + ($elm$core$String$fromInt(position.r + position.cy) + ';'))),
							'grid-column: ' + ($elm$core$String$fromInt(position.cd) + (' / ' + ($elm$core$String$fromInt(position.cd + position.d_) + ';')))
						]));
				var _class = '.grid-pos-' + ($elm$core$String$fromInt(position.r) + ('-' + ($elm$core$String$fromInt(position.cd) + ('-' + ($elm$core$String$fromInt(position.d_) + ('-' + $elm$core$String$fromInt(position.cy)))))));
	...
	function (name, modifier, _v0) {
		...
		return _List_fromArray(
			[
				...
				A2($mdgriffith$elm_ui$Internal$Model$bracket, '.' + (name + ('.' + (modifier + ('> .' + ($mdgriffith$elm_ui$Internal$Style$classes.dw + (', .' + (name + (' .' + (modifier + (' > .' + $mdgriffith$elm_ui$Internal$Style$classes.dw)))))))))), textAdjustment)
			]);
	});
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2(
					$mdgriffith$elm_ui$Internal$Model$bracket,
					'.' + (name + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.dj + ('> .' + ($mdgriffith$elm_ui$Internal$Style$classes.dw + (', .' + (name + (' .' + ($mdgriffith$elm_ui$Internal$Style$classes.dj + (' > .' + $mdgriffith$elm_ui$Internal$Style$classes.dw)))))))))),
					_List_fromArray(
						[
...
var $mdgriffith$elm_ui$Internal$Model$adjust = F3(
	function (size, height, vertical) {
		return {cy: height / size, bt: size, bA: vertical};
	});
...
var $mdgriffith$elm_ui$Internal$Model$convertAdjustment = function (adjustment) {
	var lines = _List_fromArray(
		[adjustment.b7, adjustment.bX, adjustment.cj, adjustment.cR]);
	var lineHeight = 1.5;
				...
				return {
					...
					Y: function () {
						...
						if (_v1.$ === 1) {
							...
							var topLevel = _v1.a;
							return A2($elm$core$List$cons, topLevel, rendered.Y);
						}
					}()
				};
			});
					...
					return A3(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class($mdgriffith$elm_ui$Internal$Style$classes.bU + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.di))
									]))
							]));
			}
		}();
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.bU, $mdgriffith$elm_ui$Internal$Style$classes.di, $mdgriffith$elm_ui$Internal$Style$classes.ae, $mdgriffith$elm_ui$Internal$Style$classes.y, $mdgriffith$elm_ui$Internal$Style$classes.bQ])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.bU, $mdgriffith$elm_ui$Internal$Style$classes.di, $mdgriffith$elm_ui$Internal$Style$classes.ae, $mdgriffith$elm_ui$Internal$Style$classes.y, $mdgriffith$elm_ui$Internal$Style$classes.bO])))
						]),
					_List_fromArray(
						[html])) : html));
			case 1:
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.bU, $mdgriffith$elm_ui$Internal$Style$classes.di, $mdgriffith$elm_ui$Internal$Style$classes.ae, $mdgriffith$elm_ui$Internal$Style$classes.bP])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.bU, $mdgriffith$elm_ui$Internal$Style$classes.di, $mdgriffith$elm_ui$Internal$Style$classes.ae, $mdgriffith$elm_ui$Internal$Style$classes.bN])))
						]),
					_List_fromArray(
						[html])) : html));
			default:
...
var $mdgriffith$elm_ui$Internal$Model$textElementClasses = $mdgriffith$elm_ui$Internal$Style$classes.bU + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.dw + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.aI + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.av)))));
...
var $mdgriffith$elm_ui$Internal$Model$textElementFillClasses = $mdgriffith$elm_ui$Internal$Style$classes.bU + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.dw + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.aJ + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.aw)))));
						...
						switch (location) {
							case 0:
								return A2(
									...
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.P, $mdgriffith$elm_ui$Internal$Style$classes.di, $mdgriffith$elm_ui$Internal$Style$classes.bH]));
							case 1:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.P, $mdgriffith$elm_ui$Internal$Style$classes.di, $mdgriffith$elm_ui$Internal$Style$classes.bZ]));
							case 2:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.P, $mdgriffith$elm_ui$Internal$Style$classes.di, $mdgriffith$elm_ui$Internal$Style$classes.cZ]));
							case 3:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.P, $mdgriffith$elm_ui$Internal$Style$classes.di, $mdgriffith$elm_ui$Internal$Style$classes.cX]));
							case 4:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.P, $mdgriffith$elm_ui$Internal$Style$classes.di, $mdgriffith$elm_ui$Internal$Style$classes.cE]));
							default:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.P, $mdgriffith$elm_ui$Internal$Style$classes.di, $mdgriffith$elm_ui$Internal$Style$classes.bY]));
						}
					}())
				]),
			_List_fromArray(
...
var $mdgriffith$elm_ui$Internal$Model$alignXName = function (align) {
	switch (align) {
		case 0:
			return $mdgriffith$elm_ui$Internal$Style$classes.ao + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.aO);
		case 2:
			return $mdgriffith$elm_ui$Internal$Style$classes.ao + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.aP);
		default:
			return $mdgriffith$elm_ui$Internal$Style$classes.ao + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bL);
	}
};
var $mdgriffith$elm_ui$Internal$Model$alignYName = function (align) {
	switch (align) {
		case 0:
			return $mdgriffith$elm_ui$Internal$Style$classes.ap + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bR);
		case 2:
			...
			return (portion === 1) ? _Utils_Tuple3(
				...
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Internal$Style$classes.bU + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.aT + (' > ' + $mdgriffith$elm_ui$Internal$Style$dot(
			...
			return (portion === 1) ? _Utils_Tuple3(
				...
				_List_fromArray(
					[
						A3(
						$mdgriffith$elm_ui$Internal$Model$Single,
						$mdgriffith$elm_ui$Internal$Style$classes.bU + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.r + (' > ' + $mdgriffith$elm_ui$Internal$Style$dot(
...
var $mdgriffith$elm_ui$Element$column = F2(
	function (attrs, children) {
		return A4(
			...
			A2(
				$elm$core$List$cons,
				$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.ce + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.U)),
				A2(
					$elm$core$List$cons,
...
var $mdgriffith$elm_ui$Internal$Model$focusDefaultStyle = {
	...
	dh: $elm$core$Maybe$Just(
		{
			M: 0,
			N: A4($mdgriffith$elm_ui$Internal$Model$Rgba, 155 / 255, 203 / 255, 1, 1),
...
var $mdgriffith$elm_ui$Internal$Model$optionsToRecord = function (options) {
	...
	return andFinally(
		A3(
			$elm$core$List$foldr,
			combine,
			{cu: $elm$core$Maybe$Nothing, cA: $elm$core$Maybe$Nothing, cT: $elm$core$Maybe$Nothing},
			options));
};
			...
			A2(
				...
				$mdgriffith$elm_ui$Internal$Model$htmlClass(
					A2(
						...
						' ',
						_List_fromArray(
							[$mdgriffith$elm_ui$Internal$Style$classes.c9, $mdgriffith$elm_ui$Internal$Style$classes.bU, $mdgriffith$elm_ui$Internal$Style$classes.di]))),
...
var $mdgriffith$elm_ui$Element$row = F2(
	function (attrs, children) {
		return A4(
			...
			A2(
				$elm$core$List$cons,
				$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.U + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.y)),
				A2(
					$elm$core$List$cons,
					$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$shrink),
					A2(
...
var $mdgriffith$elm_ui$Element$Font$semiBold = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$fontWeight, $mdgriffith$elm_ui$Internal$Style$classes.dH);
...
var $author$project$UI$Style$minMaxFillMobile = A2(
	$mdgriffith$elm_ui$Element$maximum,
	800,
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$width($author$project$UI$Style$minMaxFillMobile),
						$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill),
						$mdgriffith$elm_ui$Element$centerX
					]),
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$text('Search Top mobile!')
							]))
					]))
			]));
};
var $author$project$Search$Views$viewNotFound = A2(
	...
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$text('Route not found')
		]));
		...
		return A4(
			...
			A2(
				...
				A2(
					...
					A2(
						$elm$core$List$cons,
						$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.ag + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.y + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.de + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.ba)))))),
						A2(
							$elm$core$List$cons,
...
var $author$project$UI$Style$roundedBorder = $mdgriffith$elm_ui$Element$Border$rounded(5);
...
var $author$project$UI$Style$roundedButton = _List_fromArray(
	[
		$mdgriffith$elm_ui$Element$Border$width(1),
		$author$project$UI$Style$roundedBorder,
		$mdgriffith$elm_ui$Element$Border$color($author$project$UI$Style$darkBlue),
...
var $mdgriffith$elm_ui$Element$Input$negateBox = function (box) {
	return {b4: -box.b4, cQ: -box.cQ, c8: -box.c8, dN: -box.dN};
};
	...
	function (isMultiline, stacked, attrs) {
		return function (redist) {
			...
			A3(
				...
				{j: _List_Nil, b: _List_Nil, m: _List_Nil, a: _List_Nil, S: _List_Nil},
				attrs));
	});
				...
				_Utils_ap(
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.ba + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.c2)),
...
var $mdgriffith$elm_ui$Element$Input$textHelper = F3(
	function (textInput, attrs, textOptions) {
		...
		var redistributed = A3(
			...
			_Utils_eq(textInput.dT, $mdgriffith$elm_ui$Element$Input$TextArea),
		...
		var inputElement = A4(
			...
			_Utils_ap(
				...
				_Utils_ap(
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$Input$value(textOptions.dw),
							$mdgriffith$elm_ui$Internal$Model$Attr(
					...
					_Utils_ap(
						(heightConstrained ? $elm$core$List$cons($mdgriffith$elm_ui$Element$scrollbarY) : $elm$core$Basics$identity)(
							_List_fromArray(
								[
									$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
									A2($elm$core$List$any, $mdgriffith$elm_ui$Element$Input$hasFocusStyle, withDefaults) ? $mdgriffith$elm_ui$Internal$Model$NoAttribute : $mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.aY),
									...
									function () {
										if (textOptions.dw === '') {
											...
											if (_v1.$ === 1) {
												...
												return _List_fromArray(
													[
														A3($mdgriffith$elm_ui$Element$Input$renderPlaceholder, place, _List_Nil, textOptions.dw === '')
													]);
											}
										} else {
											return _List_fromArray(
												[
													...
													A2(
														...
														_List_fromArray(
															[
																$elm$html$Html$text(textOptions.dw + '\u00A0')
															])))
												]);
										}
									}()))
										...
										if (_v2.$ === 1) {
											...
											return _List_fromArray(
												[
													...
													A3($mdgriffith$elm_ui$Element$Input$renderPlaceholder, place, redistributed.j, textOptions.dw === ''))
												]);
										}
									}()
									])))),
...
var $mdgriffith$elm_ui$Element$Input$text = $mdgriffith$elm_ui$Element$Input$textHelper(
	{
		...
		t: false,
		dT: $mdgriffith$elm_ui$Element$Input$TextInputNode('text')
	});
var $author$project$Search$Views$viewSearchKeywordInput = function (model) {
	var queryObj = model.bm;
	return A2(
		$mdgriffith$elm_ui$Element$row,
		_List_fromArray(
			[
				...
				A2(
					...
					$author$project$UI$Style$desktopMinWidth,
					A2($mdgriffith$elm_ui$Element$maximum, $author$project$UI$Style$desktopMaxWidth, $mdgriffith$elm_ui$Element$fill)))
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						...
						{
							ay: $mdgriffith$elm_ui$Element$Input$labelHidden('Search'),
							cW: function (inp) {
				...
				_List_fromArray(
					[
						...
						{
							ay: $mdgriffith$elm_ui$Element$text('Search'),
							cY: $elm$core$Maybe$Just($author$project$Search$DataTypes$NoOp)
						})
					]))
			]));
};
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$mdgriffith$elm_ui$Element$text('Search RISM Online')
											]))
									]))
							])),
						A2(
...
var $author$project$SearchApp$view = function (model) {
	return {
		b_: $author$project$Search$Views$viewSearchBody(model),
		dM: 'RISM Online'
	};
};
var $author$project$SearchApp$main = $elm$browser$Browser$application(
	{cG: $author$project$SearchApp$init, c_: $author$project$Search$DataTypes$UrlChange, c$: $author$project$Search$DataTypes$UrlRequest, dv: $author$project$SearchApp$subscriptions, dV: $author$project$SearchApp$update, dY: $author$project$SearchApp$view});
_Platform_export({'SearchApp':{'init':$author$project$SearchApp$main(
	A2(
		$elm$json$Json$Decode$andThen,
			...
			return A2(
				...
				function (windowHeight) {
					return A2(
						...
						function (locale) {
							return $elm$json$Json$Decode$succeed(
								{az: locale, aK: windowHeight, aL: windowWidth});
						},
