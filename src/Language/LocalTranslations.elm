...
localTranslations =
    ...
    , resetAll =
        [ LanguageValue English [ "Clear search" ]
        , LanguageValue German [ "Suche löschen" ]
        , LanguageValue French [ "Effacer recherche" ]
        , LanguageValue Italian [ "Cancella ricerca" ]
        , LanguageValue Spanish [ "Borrar búsqueda" ]
        , LanguageValue Portuguese [ "Limpar pesquisa" ]
        , LanguageValue Polish [ "Wyczyść wyszukiwanie" ]
        ]
    , resultsOfOtherTypes =
