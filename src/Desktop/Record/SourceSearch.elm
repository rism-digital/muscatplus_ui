...
searchResultsViewRouter session model =
    let
        ...
        resultsConfig =
            ...
            , userInteractedWithDownloaderMsg = \_ -> RecordMsg.NothingHappened
            , userClickedOpenDownloaderMsg = RecordMsg.NothingHappened
            , userClickedCloseDownloaderMsg = RecordMsg.NothingHappened
