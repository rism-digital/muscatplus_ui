...
whiteKey { plainNote, naturalNote, octave, showSymbols, keyLabel } =
    let
        naturalLabel =
        ...
        syms =
            if showSymbols then
                Svg.node "path"
                    ...
                    , SE.onClick (keyMsg naturalNote octave)
                    ]
                    []
    ...
    , Svg.node "rect"
        ...
        , class "white-key"
        , SE.onClick (keyMsg plainNote octave)
        ]
        []
    , Svg.node "g"
...
blackKey :
    ...
    -> List (Svg.Svg KeyboardMsg)
blackKey { sharpNote, flatNote, octave, showSymbols } =
    let
        sharpLabel =
        ...
        syms =
            if showSymbols then
                [ Svg.node "path"
                    ...
                    , SE.onClick (keyMsg flatNote octave)
                    ]
                    [ Svg.node "title"
                        []
                        [ Svg.text flatLabel
                ...
                , Svg.node "path"
                    ...
                    , SE.onClick (keyMsg sharpNote octave)
                    ]
                    [ Svg.node "title"
                        []
                        [ Svg.text sharpLabel
    ...
    [ Svg.node "title"
        []
        [ String.join "/" [ flatLabel, sharpLabel ]
            |> Svg.text
        ]
    , Svg.node "path"
