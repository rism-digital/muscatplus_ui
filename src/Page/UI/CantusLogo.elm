...
cantusLogo =
    html
        (Svg.node "svg"
            ...
            , Svg.node "g"
                [ attribute "id" "Layer_4" ]
                [ Svg.node "rect"
                    [ attribute "class" "cls-1"
                    , attribute "x" "20.65"
                    , attribute "y" "48.82"
                    , attribute "width" "677.72"
                    , attribute "height" "1.78"
                    ]
                    []
                , Svg.node "rect"
                    [ attribute "class" "cls-1"
                ...
                , Svg.node "rect"
                    ...
                    , attribute "x" "107.61"
                    , attribute "y" "48.82"
                    , attribute "width" "1.78"
                    , attribute "height" "106.04"
                    ]
                    []
                , Svg.node "rect"
                    [ attribute "class" "cls-1"
            ...
            , Svg.node "g"
                ...
                , Svg.node "path"
                    [ attribute "class" "cls-2"
                    , attribute "d" "M292.39,97.3l8.67-9.67c5.67,2.83,6,10.83,6,10.83l12-10.83,5.33,5.42c3,.25,5.67-1.83,5.67-1.83.33,3.75-3.17,6.08-3.17,6.08v30.17c1.5,2.17,6.17,0,6.17,0l-8.67,9.5c-5.33-1.5-6.67-8.17-6.67-8.17v-27.19c-1.44-8.59-10.17.69-10.17.69v26l2.33,2.33-7.17,6.33-7.5-6.83,2.67-2v-30.17l-5.5-.67Z"
                    ]
                    []
                , Svg.node "path"
                    [ attribute "class" "cls-2"
                    , attribute "d" "M384.22,97.3v-3.5l12.67-15.5v13.5h9.83v5.5h-9.83v31.17c2,3.33,8.33,1.33,8.33,1.33l-8.5,9.67-9.83-8.67v-33.5h-2.67Z"
                    ]
                    []
                , Svg.node "path"
                    [ attribute "class" "cls-2"
                    , attribute "d" "M463.39,86.92l9.67-8.56,7.33,5.78c-1.89,1.33-3.22,3.22-3.22,3.22v27.44c1.39,4.42,10.67-1.22,10.67-1.22v-26.22l-3.11-3.22,7.78-5.78,7.67,5.67-3.44,3.44v30.33c1.67,1.11,6,0,6,0l-8.78,8.78c-4.67-2.56-6.22-10-6.22-10l-12.33,10c-5-2.22-7.33-7.33-7.33-7.33v-32.33h-4.67Z"
                    ]
                    []
                , Svg.node "polygon"
                    [ attribute "class" "cls-2"
                    , attribute "points" "37 89.44 20.22 104.41 20.22 100.51 37 85.53 37 82.63 20.22 97.6 20.22 85.96 37 71.24 37 60.23 20.22 75.21 20.22 71.73 37 56.33 37 53.42 15.99 72.18 16.49 72.74 16.49 78.54 14.88 79.97 14.88 131.8 16.49 131.8 16.49 138.97 18.5 138.97 18.5 146.64 20.22 146.64 20.22 115.16 37 100.44 37 89.44"
                    ]
                    []
                , Svg.node "path"
                    [ attribute "class" "cls-2"
                    , attribute "d" "M42.39,93.47v-6s4.83-10,9.83-15.17,11.17-8.17,11.17-8.17l11.17,13.33-13,13.75-7.5-6.42c-5.83,3.33-9,8.67-9,8.67h-2.67Z"
                    ]
                    []
                , Svg.node "path"
                    [ attribute "class" "cls-2"
                    , attribute "d" "M636.56,119.39s4.83-12.75,9.5-18.75,8.58-10.84,8.58-10.84l16.33,10.84s-12.08,15.91-12.33,15.75-8.83-6.67-8.83-6.67c-4.83,2.67-8.08,9.67-8.08,9.67h-5.17Z"
                    ]
                    []
                ]
            ]
