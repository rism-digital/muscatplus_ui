module Page.UI.Facets.RangeSlider exposing
...
Copied and customized from <https://github.com/stephenreddek/elm-range-slider/>
...
view (RangeSlider model) =
    ...
    div
        []
        [ Css.Global.global
            [ Css.Global.id "range-slider-container"
                [ Css.textAlign Css.center ]
            , Css.Global.class "range-slider-handle"
                [ Css.backgroundColor (Css.rgb 256 256 256)
                , Css.boxShadow4 (Css.px 0) (Css.px 1) (Css.px 5) (Css.rgba 0 0 0 0.75)
                , Css.marginLeft (Css.px -10)
                , Css.borderRadius (Css.pct 50)
                , Css.height (Css.px 20)
                , Css.width (Css.px 20)
                ]
            , Css.Global.class "range-slider-background-bar"
                [ Css.backgroundColor (Css.rgb 238 238 238)
                , Css.height (Css.px 4)
                , Css.width (Css.pct 100)
                ]
            , Css.Global.class "range-slider-bar-highlight"
                [ Css.backgroundColor (Css.rgb 92 144 209)
                , Css.height (Css.px 4)
                ]
            , Css.Global.class "range-slider-value"
                [ Css.position Css.absolute
                , Css.top (Css.px 0)
                , Css.backgroundColor (Css.rgb 92 144 209)
                , Css.color (Css.rgb 256 256 256)
            ...
            , Css.Global.class "range-slider-axis"
                [ Css.position Css.absolute
            ...
            , Css.Global.class "range-slider-axis-label"
                [ Css.position Css.absolute
                , Css.bottom (Css.px 0)
                , Css.fontSize (Css.px 9)
                , Css.transform (Css.translateX (Css.pct -50))
                , Css.color (Css.rgb 153 153 153)
                ]
            , Css.Global.class "range-slider-tick"
                [ Css.position Css.absolute
                , Css.backgroundColor (Css.rgb 153 153 153)
                , Css.width (Css.px 1)
                ]
            , Css.Global.class "range-slider-major-tick"
                [ Css.height (Css.px 8) ]
            , Css.Global.class "range-slider-minor-tick"
                [ Css.height (Css.px 4)
